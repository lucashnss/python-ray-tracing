...
class Camera:
    ...
    def __init__(self, camera_point: Point, target_point: Point, vector_up: Vector, target_distance, hres: int, vres: int):
        ...
        self.target_distance = target_distance # Distância entre a câmera e o ponto para onde ela está apontando.
